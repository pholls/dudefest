...
RailsAdmin.config do |config|
  ...
  config.audit_with :history, 'Tip'
  config.audit_with :history, 'Event'
  config.audit_with :history, 'Position'
  config.audit_with :history, 'ThingCategory'
  config.audit_with :history, 'Thing'
  config.audit_with :history, 'Video'
  ...
  # config.included_models = ['Event', 'Position', 'Thing', 'ThingCategory', 'Tip', 'User', 'Video']
  ...
  #     configure :date, :date 
  #     configure :reviewer_id, :integer 
  #     configure :reviewed_at, :datetime 
  #     configure :reviewed, :boolean 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your thing.rb model definition

  #   # Found associations:

  #     configure :thing_category, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :thing, :string 
  #     configure :image, :string 
  #     configure :description, :text 
  #     configure :date, :date 
  #     configure :thing_category_id, :integer         # Hidden 
  #     configure :reviewer_id, :integer 
  #     configure :reviewed_at, :datetime 
  #     configure :reviewed, :boolean 
  #     configure :creator_id, :integer 
  ...
  # config.model 'ThingCategory' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your thing_category.rb model definition
  ...
  #     configure :reviewed_tips, :has_many_association 
